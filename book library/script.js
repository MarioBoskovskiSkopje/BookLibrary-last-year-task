$(document).ready(function () {
    ...
    var tableAllBooks = $("#tableBooks");
    var tableAnthology = $("#tableBooksAnthology");
    var tableStories = $("#storiesAnthology");
    var submitButton = $("#saveButton");
    var getAllBooks = $("#getBooks");
    var getAnthologyBooks = $("#getAnthology");
    ...
    $(getAnthologyBooks).click(function (event) {
        event.preventDefault();

       


        var anthologyBooks = books.filter(element => {
            return element.kind === "anthology";
        });

        anthologyBooks.forEach(element => {
            let row2 = $("<tr>");

            $("<td>").text(element.kind).appendTo(row2);
            $("<td>").text(element.title).appendTo(row2);
            $("<td>").text(element.editor).appendTo(row2);
            $("<td>").text(element.publisher).appendTo(row2);
            $("<td>").text(element.year).appendTo(row2);





            tableAnthology.append(row2);
    ...
    $(getStories).click(function (event) {
        event.preventDefault();
        var getStoriesAnthology = books.filter(element => {
            return `${element}."stories"`;
        })

        getStoriesAnthology.forEach(element => {
            let row3 = $("<tr>");

            $("<td>").text(element.author).appendTo(row3);
            $("<td>").text(element.title).appendTo(row3);
            $("<td>").text(element.original === false).appendTo(row3);

            tableStories.append(row3);
        });
    ...
    $(getAllBooks).click(function (event) {
        ...
        var getNovels = books.filter(element => {
            return element.kind === "novel";
        });

        getNovels.forEach(getNovels => {
            let row1 = $("<tr>");
            $("<td>").text(getNovels.kind).appendTo(row1);
            $("<td>").text(getNovels.title).appendTo(row1);
            $("<td>").text(getNovels.author).appendTo(row1);
            $("<td>").text(getNovels.publisher).appendTo(row1);
            $("<td>").text(getNovels.year).appendTo(row1);
            $("<td>").text(getNovels.length).appendTo(row1);
            tableAllBooks.append(row1);
    ...
    $(submitButton).click(function (event) {
        ...
        var novelAnthology = $("#formGroupExampleInput").val();
        var title = $("#formGroupExampleInput2").val();
        var author = $("#formGroupExampleInput3").val();
        var publisher = $("#formGroupExampleInput4").val();
        var year = $("#formGroupExampleInput5").val();
        var length = $("#formGroupExampleInput6").val();
        var series = $("#formGroupExampleInput7").val();
        var seriesNumber = $("#formGroupExampleInput8").val();

        var tr = $("<tr>");

        var uniqueIdTd = $("<td>");
        var novelAnthologyTd = $("<td>");
        var titleTd = $("<td>");
        var authorTd = $("<td>");
        var publisherTd = $("<td>");
        var yearTd = $("<td>");
        var lengthTd = $("<td>");
        var seriesTd = $("<td>");
        var seriesNumberTd = $("<td>");
        var buttonsTd = $("<td>");

        uniqueIdTd.text(lastUniqueId);
        novelAnthologyTd.text(novelAnthology);
        titleTd.text(title);
        authorTd.text(author);
        publisherTd.text(publisher);
        yearTd.text(year);
        lengthTd.text(length);
        seriesTd.text(series);
        seriesNumberTd.text(seriesNumber);
    ...
    `);
        ...
        $(editRowButton).click(function () {
            ...
            novelAnthologyTd.html(`<input type="text" value="${novelAnthology}" id="novelAnthology1${lastUniqueId}" />`);
            titleTd.html(`<input type="text" value="${title}" id="title1${lastUniqueId}" />`);
            authorTd.html(`<input type="text" value="${author}" id="author1${lastUniqueId}" />`);
            publisherTd.html(`<input type="text" value="${publisher}" id="publisher1${lastUniqueId}" />`);
            yearTd.html(`<input type="text" value="${year}" id="year1${lastUniqueId}" />`);
            lengthTd.html(`<input type="text" value="${length}" id="length1${lastUniqueId}" />`);
            seriesTd.html(`<input type="text" value="${series}" id="series1${lastUniqueId}" />`);
            seriesNumberTd.html(`<input type="text" value="${seriesNumber}" id="seriesNumber1${lastUniqueId}" />`);
            ...
            $(saveRowButton).click(function () {
                ...
                novelAnthology = $(`#novelAnthology1${lastUniqueId}`).val();
                title = $(`#title1${lastUniqueId}`).val();
                author = $(`#author1${lastUniqueId}`).val();
                publisher = $(`#publisher1${lastUniqueId}`).val();
                year = $(`#year1${lastUniqueId}`).val();
                length = $(`#length1${lastUniqueId}`).val();
                series = $(`#series1${lastUniqueId}`).val();
                seriesNumber = $(`#seriesNumber1${lastUniqueId}`).val();
