$(document).ready(function () {
    ...
    var table = $("#books-table1");
    var submitButton = $("#submitButton");
    var discardButton = $("#deleteButton");
    var form = $("#form-group1");
    var lastUniqueId = 1;
    ...
    $(submitButton).click(function (event) {
        ...
        var novelAnthology = $("#formGroupExampleInput9").val();
        var title = $("#formGroupExampleInput10").val();
        var author = $("#formGroupExampleInput11").val();
        var publisher = $("#formGroupExampleInput12").val();
        var year = $("#formGroupExampleInput13").val();
        var length = $("#formGroupExampleInput14").val();
        var series = $("#formGroupExampleInput15").val();
        var seriesNumber = $("#formGroupExampleInput16").val();
